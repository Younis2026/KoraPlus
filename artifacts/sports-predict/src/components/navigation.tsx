...
import { Home, Trophy, BarChart3, User, Newspaper, Medal } from 'lucide-react';
...
export function Navigation() {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-border/40 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 pb-safe">
